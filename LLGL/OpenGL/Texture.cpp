...
Texture Texture::create_from_color_array(Util::Vector2u size, Util::Colorf const* array, Format format)
{
...
void Texture::update(Util::Vector2u dst_pos, Util::Vector2u src_size, Util::Colorf const* array, Format format)
{
