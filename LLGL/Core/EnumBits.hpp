...
//
#define LLGL_ENUM_BITWISE_OPERATORS(Enum) \
    _LLGL_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, )

// Enables bitwise operators for the specified Enum type, this
// version is meant for use on enums which are private to the
// containing type.
//
#define LLGL_ENUM_BITWISE_FRIEND_OPERATORS(Enum) \
    _LLGL_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, friend)

#define _LLGL_ENUM_BITWISE_OPERATORS_INTERNAL(Enum, Prefix)                  \
                                                                           \
